...
const ZIP_URL = "https://www.dropbox.com/scl/fi/miku5gne49bojd9wd2z7g/PreppHint.Com-1-500.zip?rlkey=u9vl5cf6kruany3ojd3pt1neh&st=8vddp4ny&dl=1"; // ?dl=1
...
async function main() {
  ...
  userDataDir: "C:\\Users\\vrkbo\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 2",
  args: [
    "--no-sandbox",
  ...
  defaultViewport: null // ensures it uses full window size
});
  ...
  try {
      ...
      await processVideo(reelPath, processedPath); // ✅ Only 2 arguments now
